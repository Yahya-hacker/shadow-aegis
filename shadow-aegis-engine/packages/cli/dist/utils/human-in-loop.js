 ...
 */
export async function confirmFileEdit(filePath, targetCode, replacementCode) {
 ...
 * Returns true if user approves, false if denied.
 */
export async function confirmCommandExecution(command, warning) {
...
export async function confirmMcpToolExecution(adapterName, toolName, payload, warning) {
