...
export declare function registerSecretStoreAdapter(adapter: SecretStoreAdapter): void;
/**
 * Loads the Shadow Auditor configuration from ~/.shadow-auditor.json
 * Returns null if the file doesn't exist or is invalid
 */
export declare function loadConfig(): Promise<null | ShadowConfig>;
/**
 * Saves the Shadow Auditor configuration to ~/.shadow-auditor.json
 */
export declare function saveConfig(configData: ShadowConfig): Promise<void>;
