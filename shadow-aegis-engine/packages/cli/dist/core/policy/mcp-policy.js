 ...
 */
export function evaluateMCPPolicy(serverName, toolName, policy = {}) {
    ...
    const requiresConfirmation = (tier === 'sensitive' && fullPolicy.requireSensitiveConfirmation) ||
 ...
 */
export function isAutoApproved(decision) {
