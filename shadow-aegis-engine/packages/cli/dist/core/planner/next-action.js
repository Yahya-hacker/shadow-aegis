...
export class NextActionPlanner {
    ...
    chainManager;
    graph;
    constructor(stepManager, chainManager, graph) {
    ...
    canVerifyStep(step) {
        ...
        const verified = new Set(this.stepManager
            .getAllSteps()
     ...
     */
    createCollectEvidenceAction(step) {
        return {
