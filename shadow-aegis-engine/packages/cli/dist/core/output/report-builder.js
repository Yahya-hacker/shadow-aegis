...
import { enhancedFindingSchema, } from './finding-schema.js';
    ...
    generateMarkdown(report) {
        ...
        if (report.findings.length > 0) {
            ...
            for (const finding of report.findings) {
                lines.push(`### ${finding.vulnId}: ${finding.title}`, '', `**Severity:** ${finding.severityLabel} (CVSS ${finding.cvssV31Score})`, `**CWE:** ${finding.cwe}`, `**Confidence:** ${(finding.confidence * 100).toFixed(0)}%`, '');
