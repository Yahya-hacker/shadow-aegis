...
export function createReadFileTool(pathGuard) {
    return tool({
        description: 'Reads full source code from a repository file using hardened path guards. Use this for implementation-level security analysis.',
