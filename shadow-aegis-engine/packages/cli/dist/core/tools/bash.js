...
export function createBashTool(options) {
    return tool({
        description: 'Execute Unix shell commands for repository inspection and security analysis. ' +
        ...
        inputSchema: z.object({
            command: z
                ...
                .describe('Unix shell command to execute. Supports piping: e.g., "grep -rn eval src/ | head -20" or "cat package.json | jq .dependencies".'),
            timeout: z
                .number()
                .int()
                .positive()
