 ...
 */
export function generateCanonicalId(entityType, identifyingProps) {
 ...
 */
export function fileCanonicalId(filePath) {
    return generateCanonicalId('file', { path: normalizePath(filePath) });
}
/**
 * Generate canonical ID for a function entity.
 */
export function functionCanonicalId(fileId, functionName, lineStart) {
 ...
 */
export function sinkCanonicalId(fileId, sinkName, lineNumber) {
 ...
 */
export function sourceCanonicalId(fileId, sourceName, lineNumber) {
 ...
 */
export function vulnerabilityCanonicalId(cwe, sourceId, sinkId, title) {
 ...
 */
export function edgeCanonicalId(edgeType, sourceEntityId, targetEntityId) {
    const hash = crypto
        .createHash('sha256')
 ...
 */
export function isDuplicateEntity(a, b) {
 ...
 */
export function computeCodeHash(codeSnippet) {
